...
export default function Greeting({
  ...
  return (
    <div className="group relative w-full h-full flex flex-col">
      ...
      {/* Main greeting card */}
      <div className="relative bg-gradient-to-br from-white via-white to-blue-50/30 rounded-xl lg:rounded-2xl border-2 border-gray-200/80 shadow-sm hover:shadow-lg hover:border-blue-300/50 transition-all duration-300 p-2 sm:p-3 md:p-4 lg:p-5 xl:p-6 flex-1 min-h-0 overflow-hidden backdrop-blur-sm">
        <div className="relative z-10 h-full gap-4 flex flex-col justify-between">
          <div className="flex items-center mb-1 justify-between">
            {/* Time and date badge */}
            <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-gray-100/90 backdrop-blur-sm rounded-xl px-2.5 py-1 sm:px-3 sm:py-1.5 border border-gray-300/60 self-start">
            ...
            {totalSteps > 0 && (
              <div className="flex justify-center">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 bg-gray-100/90 hover:bg-gray-200/90 rounded-xl transition-all duration-300 text-xs sm:text-sm font-medium backdrop-blur-sm border border-gray-300/60"
                >
                  <span>
          ...
          <div className="mt-3">
            <div className="flex flex-col items-center gap-4">
              <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden border border-gray-300/40">
              <div
                ...
                >
                  ...
                  <div className="flex items-start gap-3 lg:gap-4 mb-3 lg:mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {chapter.description && (
                        <p
                          className="text-gray-600 text-sm lg:text-base leading-relaxed overflow-hidden"
                          style={{
                            display: "-webkit-box",
                            WebkitLineClamp: 2,
                            ...
                            style={{
                              left:
                                chapter.completion >= 100
                                  ? "100%"
                                  : `${Math.min(chapter.completion, 95)}%`,
                            }}
                          >
                            <div
                              className={`w-3 h-3 lg:w-5 lg:h-5 rounded-full border-2 border-white shadow-md ${
                                isCompleted ? "bg-green-500" : "bg-blue-500"
                              }`}
                            />
                          </div>
